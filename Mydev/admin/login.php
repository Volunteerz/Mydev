...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Mydev/static/assets/vendors/animate/animate.css">
	<!-- [if lt IE 9] -->
...
<body>
	<div class="login">
		<form class="login-wrap <?php echo isset($message)? 'animated shake' : '' ?>" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" novalidate autocomplete="off" >
			<img class="avatar" src="/Mydev/static/assets/imgs/default.png"></img>
	...
	<script type="text/javascript" src="/Mydev/static/assets/vendors/jquery/jquery.js"></script>
		...
		$(function(){
			...
			$email.on('blur',function(){
				...
				if(!value.trim()||!reg.test(value)){
					if($avatar.attr('src')!='/Mydev/static/assets/imgs/default.png'){
